   ...
   public class TasksContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Quote>().HasData(
                 new Quote { Id = 1, Name = "What you have to do today is insignificant, but is very important that you do it.", AppUserId = "none" },
                 new Quote { Id = 2, Name = "It's about the marathon, not the sprint.", AppUserId = "none" },
                 new Quote { Id = 3, Name = "Don't feel bad because you don't know something and feel like you can't do anything. Do what you can do and then improve.", AppUserId = "none" }
                 );
            modelBuilder.Entity<Models.Tables.Group>().HasData(
                new Models.Tables.Group { Id = 1, Name = "Health", Created = dayToday, AppUserId = "none" },
                new Models.Tables.Group { Id = 2, Name = "Education", Created = dayToday , AppUserId = "none"},
                new Models.Tables.Group { Id = 3, Name = "FriendsAndFamily", Created = dayToday, AppUserId = "none" },
                new Models.Tables.Group { Id = 4, Name = "Sport", Created = dayToday, AppUserId = "none" },
                new Models.Tables.Group { Id = 5, Name = "Work", Created = dayToday, AppUserId = "none" },
                new Models.Tables.Group { Id = 6, Name = "Hobby", Created = dayToday, AppUserId = "none" },
                new Models.Tables.Group { Id = 7, Name = "Relaxation", Created = dayToday , AppUserId = "none"},
                new Models.Tables.Group { Id = 8, Name = "Entertaiment", Created = dayToday , AppUserId = "none"},
                new Models.Tables.Group { Id = 9, Name = "Finance", Created = dayToday, AppUserId = "none" }
                );

            modelBuilder.Entity<Task>().HasData(
              new Task { Id = 1, Name = "Running", GroupId = 4,   Created = dayToday, AppUserId = "none" },
              new Task { Id = 2, Name = "Reading", GroupId = 2,   Created = dayToday , AppUserId = "none"},
              new Task { Id = 3, Name = "Cooking", GroupId = 1,   Created = dayToday , AppUserId = "none"},
              new Task { Id = 4, Name = "Dancing", GroupId = 7,   Created = dayToday , AppUserId = "none"}
              );
            ...
            modelBuilder.Entity<Setting>().HasData(
              new Setting { Id = 1, Name = "AlarmClock" , Value = "Off", AppUserId = "none" }
              );
